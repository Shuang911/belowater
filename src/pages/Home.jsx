...
const Home = () => {
  ...
  return (
    ...
    <div className="relative bg-ghostwhite w-full h-[165.94rem] flex flex-col items-center justify-center gap-[3.13rem] text-left text-[1.75rem] text-indigo_900 font-catamaran" style={{overflowX: 'hidden'}}>
      ...
      <div className="absolute top-[16.62rem] left-[0rem] text-[1rem] leading-[4rem] text-darkslategray-200 text-left flex items-center w-[18.31rem] h-[9.63rem]">
        We have games, quizzes and even a way to identify a fishy friend if you
        saw one!
      </div>
      <img
        ...
        <div className="absolute top-[3.93rem] left-[5.5rem] leading-[2.5rem] flex items-center w-[14.63rem] h-[9.75rem] text-white">
          <span className="[line-break:anywhere] w-full">
            ...
            <p className="m-0 text-[1rem] text-snow">
              Learn more about our fishy friends and test your knowledge by
              quizzing yourself!
            </p>
          </span>
        </div>
      ...
      <div className="absolute top-[20.61rem] left-[18.19rem] w-[23.25rem] h-[19.02rem] text-white">
        ...
        <div className="absolute top-[5.14rem] left-[3.13rem] leading-[1.88rem] flex items-center w-[17.56rem] h-[11.81rem]">
          ...
          <a href="/identification" className="text-white">
            <p className="m-0 [text-decoration:underline]">Friend Identifier</p>
          </a>
            <p className="m-0 text-[1rem] text-snow">{`Did you see a fishy friend when you went whale or dolphin watching but not sure who they are? We have a neat little tool to help you identify them if you snapped a pic! `}</p>
          </span>
        </div>
      </div>
        ...
        <div className="absolute top-[4.62rem] left-[5.19rem] leading-[2.5rem] flex items-center w-[14.63rem] h-[9.75rem] text-white">
          ...
          <a href="/plastic" className="text-white">
            ...
            <p className="m-0 text-[1rem] text-snow">
              ...
              quizzes) and how to protect them!
            </p>
          </span>
        </div>
      </div>
      ...
      <div className="absolute top-[4.18rem] left-[24rem] leading-[2.5rem] flex items-center w-[14.63rem] h-[9.75rem] text-white">
        ...
        <a href="/game" className="text-white">
          <p className="m-0 [text-decoration:underline]">Ocean helper game</p>
        </a>
          <p className="m-0 text-[1rem] text-snow">
            Help our fishy friends by removing plastics in the ocean in a fun
            little game~!
          </p>
        </span>
      </div>
