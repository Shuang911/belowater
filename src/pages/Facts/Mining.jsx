        ...
        <div className="relative bg-colors-basic-color-3 w-full h-[109.06rem] overflow-hidden text-center text-[1.06rem] text-colors-basic-color-3 font-montserrat">
          <div className="absolute h-[99.74%] w-full  right-[0%]  left-[0%] text-left text-[2.25rem] text-colors-basic-color-1 font-headline-01">
            ...
            <div className="absolute w-[32.23%] top-[calc(50%_-_682.5px)] left-[51.44%] text-[1rem] tracking-[-0.36px] leading-[1.63rem] text-colors-basic-color-2 inline-block h-[55.93rem]">
              <p className="m-0">
                Mining is the process of extracting materials from beneath the
                earth. Ocean mining is when this takes place below the surface
                of the water. There are many different types of Ocean Mining and
                they can impact the oceans in different ways.
              </p>
              <p className="m-0">
                Seabed mining is the process of harvesting materials from the
                sea floor. In recent years, increasing requirements for valuable
                metals and materials have led to companies spending a lot of
                time exploring the ocean looking for undiscovered deposits.
              </p>
              <p className="m-0">&nbsp;</p>
              <p className="m-0">
                These companies use a sort of underwater radar to help them find
                these deposits before sifting through lots of sand and rock
                trying to find the valuable minerals and metals.
              </p>
              <p className="m-0">&nbsp;</p>
              <p className="m-0">
                The trouble is materials are not always grouped together and the
                process of sorting out metals from rocks and sand is very messy,
                often making the water dirty for fish and sea life to
                live.Sifting means sorting out what's valuable from what's not.
              </p>
              <p className="m-0">&nbsp;</p>
              <p className="m-0">
                This process of sifting heavily impacts on the surrounding ocean
                often disturbing or disrupting the local ocean ecosystem in the
                process.
              </p>
              <p className="m-0">&nbsp;</p>
              <p className="m-0">
                Sometimes the material that is being extracted can be harmful if
                it gets into the ocean. Drilling for oil can lead to it leaking
                and hurting the growth of fish nearby. Oil spills are very
                difficult to clean and can have a large impact on the
                environment.
              </p>
              <p className="m-0">&nbsp;</p>
              <p className="m-0">
                <b>
                  In recent years, increasing requirements for valuable metals
                  and materials have led towards a larger focus for examining
                  and harvesting materials from the ocean floor.  We need to
                  make sure that the risks of each new mine are known and the
                  benefits weighed very carefully against them.
                </b>
              </p>
