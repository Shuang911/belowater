      ...
      <div className="relative bg-colors-basic-color-3 w-full h-[109.06rem] overflow-hidden text-center text-[1.06rem] text-colors-basic-color-3 font-montserrat">
        <div className="absolute h-[99.74%] w-full top-[0.13%] right-[0%] bottom-[0.13%] left-[0%] text-left text-[2.25rem] text-colors-basic-color-1 font-headline-01">
          ...
          <div className="absolute w-[32.23%] top-[calc(50%_-_682.5px)] left-[51.44%] text-[1rem] tracking-[-0.36px] leading-[1.63rem] text-colors-basic-color-2 inline-block h-[55.93rem]">
            <p className="m-0">
              Oceans represent 2/3 of the planet's surface and are extremely
              impacted by climate change. They work to keep our climates stable
              by storing heat from the sun.
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              They have absorbed 93% of the heat created by trapped greenhouse
              gases thus far. Unfortunately absorbing this much energy has had
              some major negative effects on the ocean, with ocean temperatures
              rising, marine heat waves and ocean acidification.
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              Consequences are dramatic for marine ecosystems. With the water
              warming, numerous species living in cold water could be
              disappearing. And animals and plants that are used to warmer
              waters, could still lose their homes because warmer waters hold
              less oxygen, making it difficult for anything to survive.
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              The united nations predict that a 1*c rise in ocean temperatures
              will affect between 70-90% of all coral reefs and a 2*c rise will
              damage 99%.
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              Toxic algae could proliferate and make some ecosystems
              uninhabitable for marine mammals. Finally, the rise of sea waters
              is alarming. It could be up to between 40 and 100 cm making some
              islands and coasts disappear.
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              <b>
                How can you help? Climate change is caused by greenhouse gases
                in the atmosphere. The only way to reduce this is to reduce our
                emissions. Here is some ways you can do this:
              </b>
            </p>
            <p className="m-0">• Using green renewable energy such as solar</p>
            <p className="m-0">
              • Walking or using public transport instead of driving, whenever
              possible
            </p>
            <p className="m-0">
              • Research the companies that you or your parents use, encourage
