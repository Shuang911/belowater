      ...
      <div className="relative bg-colors-basic-color-3 w-full h-[109.06rem] overflow-hidden text-center text-[1.06rem] text-colors-basic-color-3 font-montserrat">
        <div className="absolute h-[99.74%] w-full top-[0.13%] right-[0%] bottom-[0.13%] left-[0%] text-left text-[2.25rem] text-colors-basic-color-1 font-headline-01">
          ...
          <div className="absolute w-[32.23%] top-[calc(50%_-_682.5px)] left-[51.44%] text-[1rem] tracking-[-0.36px] leading-[1.63rem] text-colors-basic-color-2 inline-block h-[55.93rem]">
            <p className="m-0">
              Plastic pollution is one of the biggest problems facing the ocean
              right now. It is the largest source of ocean contamination.
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              Plastic is one of the most commonly used materials and its
              production worldwide is increasing. It's lightweight, easy to make,
              tough and long lasting, however these qualities are also its biggest
              problem.
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              Unwanted plastic products such as drink bottles, plastic bags, candy
              wrappers, are often not disposed of properly. This unwanted plastic
              waste is normally just thrown away and is moved by the wind and the
              rain, ending up in rivers and streams and eventually the ocean. 
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              Here ocean currents carry them around, spreading them all over the
              world. As the plastic waste travels it doesn’t break down, it just
              breaks into smaller and smaller pieces. In many cases birds, fish
              and other sea life mistake these little bits of garbage for food,
              eating them and making them very sick.
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              For the bigger pieces of plastic, they are much tougher to break
              down and occasionally get trapped together and form huge groups of
              floating plastic, sometimes called a swath due to its size. One of
              the biggest is called the great pacific garbage patch and is twice
              the size of NSW (almost 20% the size of Australia).
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              <b>
                Some easy ways to cut down on the amount of plastic that ends up
                in the ocean are:
              </b>
            </p>
            <p className="m-0">
            ...
            <p className="m-0">
              • Disposing of plastic products properly, check to see if it has a
              recycling logo on it, if so recycle
            </p>
            <p className="m-0">
