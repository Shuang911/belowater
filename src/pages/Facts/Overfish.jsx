      ...
      <div className="relative bg-colors-basic-color-3 w-full h-[109.06rem] overflow-hidden text-center text-[1.06rem] text-colors-basic-color-3 font-montserrat">
        <div className="absolute h-[99.74%] w-full top-[0.13%] right-[0%] bottom-[0.13%] left-[0%] text-left text-[2.25rem] text-colors-basic-color-1 font-headline-01">
          ...
          <div className="absolute w-[32.23%] top-[calc(50%_-_682.5px)] left-[51.44%] text-[1rem] tracking-[-0.36px] leading-[1.63rem] text-colors-basic-color-2 inline-block h-[55.93rem]">
            <p className="m-0">
            Fish is a fantastic source of food for humans but if we take too many from the sea, it can lead to serious problems for the health of our oceans.          </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
            Overfishing is when the fish population can not reproduce naturally the amount of fish that is being fished.            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
            We need to allow the fish enough to reproduce to replace the fish that we eat before we catch any. If we keep fishing then they will not be able to reproduce in time and could become extinct.            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
            Overfishing is a serious problem for all creatures in the oceans, not just the ones that fisherpeople are trying to catch. The method of using large nets to catch a lot of fish can also be very dangerous to lots of other animals. Dolphins can become stuck in the nets and drown and other sea creatures can also be injured.            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
            If there are less fish that means that there is less food for animals like sharks to eat, so that will lead to less sharks.            </p>
            Eating fish is not only delicious but it is very good for us and catching fish gives many people jobs to support their families. So we do not want to end all fishing! We need to make sure that all countries are fishing in a responsible way so that fish populations remain strong.
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              <b>
                How can you help?
            ...
            <p className="m-0">
              • Make sure that the fish you buy and eat has been fished responsibly
            </p>
            <p className="m-0">
              • Do not buy fish products when you cannot confirm that they were responsibly caught
            </p>
            {/* <p className="m-0">
