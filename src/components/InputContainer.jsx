const InputContainer = () => {
  return (
    <div className="absolute top-[0rem] left-[0.03rem] w-[37.81rem] h-[23.13rem] text-center text-[0.88rem] text-dimgray font-catamaran">
      ...
      <img
        className="absolute top-[7.66rem] left-[13.31rem] rounded-3xs w-[9.44rem] h-[8.83rem] object-cover"
        alt=""
        src="/input@2x.png"
      />
      <img
