  ...
  return (
    <div className="flex flex-row items-center justify-start gap-[1.31rem] font-abyssinica-sil">
      ...
      <div className="flex flex-row items-center justify-center gap-[3.13rem] text-[1.13rem]">
        <a
          href="/home"
          className="relative w-[3.63rem] h-[1.5rem] shrink-0 text-[1.38rem] no-underline"
        >
        ...
        <a
          href="/game"
          className="relative leading-[155.5%] inline-block w-[7.38rem] h-[1.75rem] shrink-0 no-underline"
        >
          Ocean Helper
        </a>
        <a
          href="/quiz"
          className="relative leading-[155.5%] inline-block w-[9.88rem] h-[1.81rem] shrink-0 no-underline"
        >
          Ocean Friend Quiz
        </a>
        <a
          href="/identification"
          className="relative leading-[155.5%] inline-block w-[10.56rem] h-[1.81rem] shrink-0 no-underline"
        >
          Identification
        </a>
      </div>
