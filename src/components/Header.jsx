  ...
  return (
    <div className="flex flex-row items-center justify-start gap-[1.31rem] font-abyssinica-sil">
      ...
      <div className="flex flex-row items-center justify-center gap-[3.13rem] text-[1.13rem]">
        <a
          href="/home"
          className="relative w-[3.63rem] h-[1.5rem] shrink-0 text-[1.13rem] no-underline "
        >
          ...
          <div className="absolute top-[calc(50%_-_12px)] left-[calc(50%_-_29px)] leading-[1.5rem] hover:text-gray-500">
            Home
          </div>
        </a>
        <a
          href="/game"
          className="relative leading-[155.5%] inline-block w-[7.38rem] h-[1.75rem] shrink-0 no-underline hover:text-gray-500 cursor-pointer"
        >
          Ocean Helper
        </a>
        <a
          href="/quiz"
          className="relative leading-[155.5%] inline-block w-[9.88rem] h-[1.81rem] shrink-0 no-underline hover:text-gray-500 cursor-pointer"
        >
          Ocean Friend Quiz
        </a>
        <a
